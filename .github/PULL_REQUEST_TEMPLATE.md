...
- [ ] No hand edits to generated files: `docs/app/index.html`, `docs/app/sw.js`, `app/src/main/assets/spheredex.html`, `ios/SphereDex/SphereDex/Resources/spheredex.html` (regenerate instead) — and the mirrored image folders `docs/app/img/` / `app/src/main/assets/img/` / `ios/.../img/`, which `rebuild.py` mirrors from `docs/app/img/`.
